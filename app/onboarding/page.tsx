          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                ...
                className="w-full bg-gradient-warm text-white shadow-lg shadow-primary/30 hover:shadow-primary/40 hover:scale-[1.02] transition-all duration-300 h-12 text-base font-semibold disabled:opacity-50 disabled:hover:scale-100"
              >
                {loading ? (
